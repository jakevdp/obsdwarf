...
There is no statistically significant correlation between the force and
...
half light radius and the warp, with slopes listed in the top left corner.
...
using the absolute value of the weighted average of difference between
...
Another important caveat is that we use a large, heterogeneous data set to
...
right side warp and S-type/N-type will have same signs for both sides.
...
\caption{Left : The cumulative histogram of $w_e$ (see text for the
